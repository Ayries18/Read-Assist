...
@section('content')
    ...
    <div class="player-container">
        ...
        <h2 id="book-title" class="player-title text-gradient">{{ $audioBook->judul }}</h2>
        <p class="player-author">✍️ {{ $audioBook->penulis ?: 'Penulis tidak diketahui' }}</p>
        ...
        <div style="background: rgba(255, 255, 255, 0.02); border: 1px solid var(--border-glass); border-radius: 12px; padding: 1.2rem; text-align: left; max-width: 550px; margin: 2.5rem auto 0 auto;">
