        ...
        <section class="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-8 items-center py-8">
            <div class="flex flex-col gap-6">
                <div class="flex items-center gap-2">
                    <span class="text-[0.78rem] bg-indigo-500/10 px-3.5 py-1.5 rounded-full text-indigo-400 font-bold border border-indigo-500/25 uppercase tracking-wider">
                ...
                <p class="text-lg text-slate-300 leading-relaxed max-w-xl m-0">
                ...
                <div class="flex gap-4 flex-wrap mt-3 items-center">
                    <a href="{{ route('audio-books.index') }}" class="btn btn-primary rounded-xl px-8 py-3 text-base flex items-center gap-2 shadow-lg shadow-indigo-500/30">
                        Buka Katalog Buku
                    </a>
                    @if (!session()->has('auth_role'))
                        <a href="{{ route('login') }}" class="btn btn-ghost rounded-xl px-7 py-3 text-base font-semibold">
                            Masuk Ke Akun
                        </a>
                    @endif
                </div>
            ...
            <div class="simulation-widget-container border shadow-sm p-8 flex flex-col gap-6 relative" style="background: #121316; border-color: rgba(255, 255, 255, 0.08); border-radius: 24px;">
                <div class="flex justify-between items-center border-b border-white/5 pb-3">
                    <div class="flex items-center gap-2">
                        ...
                        <h3 class="m-0 text-base font-bold text-white">Simulasi Pemutar Audio</h3>
                    </div>
                    <span class="text-[0.72rem] text-emerald-400 bg-emerald-400/10 px-2.5 py-1 rounded-full font-bold">Uji Coba</span>
                </div>
                ...
                <div class="border rounded-2xl p-5 flex gap-4 items-center relative overflow-hidden" style="background: #1c1c1e; border-color: rgba(255, 255, 255, 0.08);">
                    ...
                    <div class="overflow-hidden flex-1">
                        <h4 class="m-0 mb-1 text-sm font-bold text-white truncate">Panduan Awal Sistem</h4>
                        <p class="m-0 mb-1 text-xs text-slate-400">Tim Pengembang Read-Assist</p>
                        <div class="inline-flex items-center gap-1 bg-slate-900 px-2 py-0.5 rounded-md text-[0.7rem] text-slate-200 border border-white/5">
                            <span class="text-indigo-400 font-bold">[QR]</span> RA-GUIDE-2026
                        </div>
                    </div>
                    <!-- Mock QR Code Stamp on physical book -->
                    <div class="bg-white p-1 rounded-md flex items-center justify-center shadow-lg shrink-0">
                        <img src="{{ route('qr-code.generate', ['data' => 'demo', 'size' => 48]) }}" alt="Mock QR" class="w-9 h-9 block">
                    </div>
                </div>
                ...
                <div class="border rounded-2xl p-5 flex flex-col gap-4 text-center" style="background: rgba(0, 0, 0, 0.2); border-color: rgba(255, 255, 255, 0.08);">
                    ...
                    <div id="sim-wave" class="flex justify-center items-end gap-0.5 h-5 opacity-30 transition-opacity duration-300">
                        <div class="w-[3px] h-1.5 bg-indigo-400 rounded-sm"></div>
                        <div class="w-[3px] h-3 bg-indigo-400 rounded-sm"></div>
                        <div class="w-[3px] h-[18px] bg-indigo-400 rounded-sm"></div>
                        <div class="w-[3px] h-2.5 bg-indigo-400 rounded-sm"></div>
                        <div class="w-[3px] h-3.5 bg-indigo-400 rounded-sm"></div>
                        <div class="w-[3px] h-1.5 bg-indigo-400 rounded-sm"></div>
                    </div>
        ...
        <section class="py-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="card border shadow-sm p-8 relative transition-all duration-300" style="background: #121316; border-color: rgba(255, 255, 255, 0.08); border-radius: 16px;">
                    ...
                    <h3 class="text-lg font-bold text-white m-0 mb-3">Pendaftaran Buku</h3>
                ...
                <div class="card border shadow-sm p-8 relative transition-all duration-300" style="background: #121316; border-color: rgba(255, 255, 255, 0.08); border-radius: 16px;">
                    ...
                    <h3 class="text-lg font-bold text-white m-0 mb-3">Pemasangan Kode QR</h3>
                    <p class="text-slate-400 text-sm leading-relaxed m-0">
                ...
                <div class="card border shadow-sm p-8 relative transition-all duration-300" style="background: #121316; border-color: rgba(255, 255, 255, 0.08); border-radius: 16px;">
                    ...
                    <h3 class="text-lg font-bold text-white m-0 mb-3">Pemindaian & Pemutaran</h3>
                    <p class="text-slate-400 text-sm leading-relaxed m-0">
        ...
        <section class="py-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="card border shadow-sm p-8 flex flex-col gap-4 transition-all duration-300" style="background: #121316; border-color: rgba(255, 255, 255, 0.08); border-radius: 16px;">
                    ...
                    <h3 class="text-lg font-bold text-white m-0">Aksesibilitas Tinggi</h3>
                    <p class="text-slate-400 text-sm leading-relaxed m-0">
                ...
                <div class="card border shadow-sm p-8 flex flex-col gap-4 transition-all duration-300" style="background: #121316; border-color: rgba(255, 255, 255, 0.08); border-radius: 16px;">
                    ...
                    <h3 class="text-lg font-bold text-white m-0">Penyimpanan Progres Otomatis</h3>
                    <p class="text-slate-400 text-sm leading-relaxed m-0">
                ...
                <div class="card border shadow-sm p-8 flex flex-col gap-4 transition-all duration-300" style="background: #121316; border-color: rgba(255, 255, 255, 0.08); border-radius: 16px;">
                    ...
                    <h3 class="text-lg font-bold text-white m-0">Inklusif & Tanpa Hambatan</h3>
                    <p class="text-slate-400 text-sm leading-relaxed m-0">
