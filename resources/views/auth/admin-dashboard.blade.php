    ...
    <div style="max-width: 800px; margin: 0 auto;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(170px, 1fr)); gap: 1.2rem; margin-bottom: 2.5rem;">
            ...
            <div class="card" style="padding: 1.25rem; text-align: center;">
                <div class="card-content">
                    <span style="font-size: 1.8rem; display: block; margin-bottom: 0.25rem;">👥</span>
                    <span style="font-size: 0.75rem; text-transform: uppercase; color: var(--text-muted); font-weight: 600; letter-spacing: 0.5px;">Anggota</span>
            ...
            <div class="card" style="padding: 1.25rem; text-align: center;">
                <div class="card-content">
                    <span style="font-size: 1.8rem; display: block; margin-bottom: 0.25rem;">🔐</span>
                    <span style="font-size: 0.75rem; text-transform: uppercase; color: var(--text-muted); font-weight: 600; letter-spacing: 0.5px;">Admin</span>
